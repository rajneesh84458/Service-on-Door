...
export default class PoolingScreen extends Component {
  ...
  render() {
    return (
      ...
      <View style={{flex:0.6,borderColor:'transparent',borderWidth:1,justifyContent:'center',alignItems:'center'}}>
        ...
        <Button rounded info style={{alignItems:'center',justifyContent:'center',width:160,marginLeft:80,marginTop:20}}>
